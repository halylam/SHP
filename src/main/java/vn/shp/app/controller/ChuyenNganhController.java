...
import vn.shp.app.bean.ChuyenNganhBean;
...
public class ChuyenNganhController extends AbstractController{
    ...
    public String getList(Model model, HttpServletRequest request) {
        ChuyenNganhBean bean = new ChuyenNganhBean();
    ...
    public String postList(@ModelAttribute(value = "bean") @Valid ChuyenNganhBean bean, BindingResult bindingResult, Model model, HttpServletRequest request,
    ...
    public String postCreate(@ModelAttribute(value = "chuyenNganhModel") @Valid ChuyenNganhBean bean,
    ...
    public String getEdit(@PathVariable(value = "") Long id,
                          ChuyenNganhBean bean, Model model) {
    ...
    public String postEdit(ChuyenNganhBean bean, Model model, Locale locale, BindingResult bindingResult) {
