...
import vn.shp.app.bean.CaHocBean;
...
public class CaHocController  extends AbstractController{
    ...
    public String postList(@ModelAttribute(value = "bean") @Valid CaHocBean bean, BindingResult bindingResult, Model model, HttpServletRequest request,
    ...
    public String postCreate(@ModelAttribute(value = "caHocModel") @Valid CaHocBean bean,
    ...
    public String postEdit(CaHocBean bean, Model model, Locale locale, BindingResult bindingResult) {
