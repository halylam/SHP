...
import vn.shp.app.bean.BacDaoTaoBean;
...
public class BacDaoTaoController extends AbstractController {
    ...
    public String getList(Model model, HttpServletRequest request) {
        BacDaoTaoBean bean = new BacDaoTaoBean();
    ...
    public String postList(@ModelAttribute(value = "bean") @Valid BacDaoTaoBean bean, BindingResult bindingResult, Model model, HttpServletRequest request,
    ...
    public String postCreate(@ModelAttribute(value = "bacDaoTaoModel") @Valid BacDaoTaoBean bean,
    ...
    public String getEdit(@PathVariable(value = "") Long id,
                          BacDaoTaoBean bean, Model model) {
    ...
    public String postEdit(BacDaoTaoBean bean, Model model, Locale locale, BindingResult bindingResult) {
