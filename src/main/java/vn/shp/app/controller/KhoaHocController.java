...
import vn.shp.app.bean.KhoaHocBean;
...
public class KhoaHocController  extends AbstractController{
	...
	public String getList(Model model, HttpServletRequest request) {
		KhoaHocBean bean = new KhoaHocBean();
	...
	public String postList(@ModelAttribute(value = "bean") @Valid KhoaHocBean bean, BindingResult bindingResult, Model model,
	...
	public String postCreate(@ModelAttribute(value = "khoaHocModel") @Valid KhoaHocBean bean,
	...
	public String getEdit(@PathVariable(value = "") Long id, KhoaHocBean bean, Model model) {
	...
	@ResponseBody
	public ModelAndView addKhoaHocMonHoc(Model model, KhoaHocBean bean, Locale locale) {
		MessageList messageLst = new MessageList(Message.SUCCESS);
		String msgInfo = "";
		try {
	...
	public String postEdit(KhoaHocBean bean, Model model, Locale locale, BindingResult bindingResult) {
	...
	public String getLstDangKy(Model model, KhoaHocBean bean, @PathVariable("id") Long id) {
	...
	public String getDangKy(Model model, KhoaHocBean bean) {
		bean.setLstKhoaHocDangKy(khoaHocService.findKhoaHocDangKy());
	...
	public String postDangKy(Model model, KhoaHocBean bean) {
		bean.setLstKhoaHocDangKy(khoaHocService.findKhoaHocDangKy());
