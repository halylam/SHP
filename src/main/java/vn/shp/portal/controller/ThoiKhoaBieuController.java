...
import vn.shp.portal.model.ThoiKhoaBieuModel;
import vn.shp.portal.model.ThoiKhoaBieuModel;
import vn.shp.portal.model.ThoiKhoaBieuModel;
...
public class ThoiKhoaBieuController  extends AbstractController{
	...
	public String postCreate(@ModelAttribute(value = "thoiKhoaBieuModel") @Valid ThoiKhoaBieuModel bean,
	...
	public String postEdit(ThoiKhoaBieuModel bean, Model model, Locale locale, BindingResult bindingResult) {
